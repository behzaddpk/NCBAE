...
from school.views import user_logout
...
urlpatterns = [
    ...
    path('admin-lecture', views.admin_lecture, name='admin-lecture'),
    path('admin-lecture-view/<str:cl>/', views.admin_lecture_view, name='admin-lecture-view'),
    ...
    path('student-lecture-view', views.student_lecture_view, name='student-lecture-view'),

    path('teacher-lecture', views.teacher_lecture, name='teacher-lecture'),
    path('teacher-upload-lecture/<str:cl>/', views.teacher_upload_lecture, name='teacher-upload-lecture'),
    path('teacher-lecture-view/<str:cl>', views.teacher_lecture_view, name='teacher-lecture-view'),

    path('teacher-upload-pdf/<str:cl>/', views.teacher_upload_pdf, name='teacher-upload-pdf'),
